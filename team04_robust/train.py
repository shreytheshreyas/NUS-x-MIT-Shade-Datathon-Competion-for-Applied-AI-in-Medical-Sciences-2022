...
def parse():
    ...
    parser.add_argument("--encoder_name", type=str, default="AlexNet_win", help = "AlexNet | VGGNet | ResNet | ViT | ConvNext") # in order of increasing performance
...
class Trainer(pl.LightningModule):
    ...
    def _step(self, b):
        ...
        loss1 = COMPUTE_LOSS(logits, ys, self.args.weights)
            
        return loss1, ys, logits
...
if __name__ == '__main__':
    ...
    logger_name  = f"model:{args.encoder_name}"
    ...
    callback_name     = f"model:{args.encoder_name}"
